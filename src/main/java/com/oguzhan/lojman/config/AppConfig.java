package com.oguzhan.lojman.config;
...
@Configuration
@ComponentScan(basePackages = "com.oguzhan.lojman")
public class AppConfig {
    ...
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        factoryBean.setAnnotatedClasses(LojmanDairesi.class, LojmanBlok.class, User.class, UserRole.class);
        return factoryBean;
    }
